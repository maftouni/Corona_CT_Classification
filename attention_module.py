...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def forward(self, x):
        ...
        #
        #print('self.interpolation1(out_middle_2r_blocks)',list(self.interpolation1(out_middle_2r_blocks).shape))
  #      print('out_down_residual_blocks1',list(out_down_residual_blocks1.shape))
...
class AttentionModule_stage2_cifar(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('out_conv1_1_blocks',list(out_conv1_1_blocks.shape))
        #print('out_trunk',list(out_trunk.shape))
        out = (1 + out_conv1_1_blocks) * out_trunk
        out_last = self.last_blocks(out)
